...
from gozerbot import Object, get, items, keys, register, update, values
from gozerbot import load, otype, save
from gozerbot import edit, printable
from gozerbot import ObjectDecoder, ObjectEncoder
...
class TestObject(unittest.TestCase):
    ...
    def test_otype(self):
        self.assertEqual(otype(Object()), "gozerbot.obj.Object")
